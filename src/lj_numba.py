...
These are optimized versions of the core LJ functions for use in long-running
simulations. They maintain the same physics as the reference Python implementations.
"""
